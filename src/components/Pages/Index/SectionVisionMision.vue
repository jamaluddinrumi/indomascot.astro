...
<template>
  <div
    id="visi-misi"
    class="grid w-screen grid-cols-1 lg:mt-24 lg:-ml-0 lg:w-auto lg:grid-cols-2"
  >
    <div
    ...
    >
      <h3
        id="misi-kami"
        class="px-4 text-center text-xl font-semibold leading-8 text-idm-title lg:px-8 lg:text-3xl lg:leading-10"
      >
        {{ t("yourSuccess") }}
      </h3>
      <i18n-t
    ...
    <div class="right order-1 lg:order-2">
      <Image
        cdn="storyblok"
        class="lg:border-idm-title lg:shadow-idm-title/80 lg:rounded-xl lg:rounded-tr-lg lg:border-4 lg:shadow-2xl"
        loading="lazy"
